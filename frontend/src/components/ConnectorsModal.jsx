...
export const ConnectorsModal = ({ isOpen, onClose, token }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-4 sm:p-6 animate-fadeIn">
      <div className="bg-[#080b11] border border-[#232f48] rounded-2xl w-full max-w-5xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden">
        {/* Modal Header */}
        <div className="p-6 border-b border-[#232f48] flex items-center justify-between bg-[#141b2d]">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-xl text-slate-400 hover:text-slate-100 hover:bg-[#080b11] transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        {/* Category Filters */}
        <div className="px-6 py-3 border-b border-[#232f48] bg-[#080b11] flex items-center space-x-2 overflow-x-auto no-scrollbar">
          {categories.map((cat) => (
            <button
              key={cat}
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-semibold whitespace-nowrap transition-all ${
                selectedCategory === cat
                  ...
                  : 'text-slate-400 hover:text-amber-300 hover:bg-[#141b2d]'
              }`}
            >
              {cat}
            </button>
              ...
              return (
                <div
                  ...
                  className={`rounded-xl border transition-all duration-200 ${
                    isConnected
                      ? 'bg-[#141b2d] border-amber-400/40 shadow-lg shadow-amber-950/30'
                  ...
                  <div className="p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center space-x-2.5 self-end sm:self-center shrink-0">
                      <button
                        ...
                        className="px-3 py-2 rounded-lg text-xs font-semibold bg-[#080b11] hover:bg-[#1d273e] text-slate-200 border border-[#232f48] transition-all flex items-center space-x-1.5"
                      >
                      ...
                      {isConnected ? (
                        ...
                        <button
                          ...
                          className="px-4 py-2 rounded-lg text-xs font-bold bg-amber-400 hover:bg-amber-300 text-slate-950 font-black shadow-md shadow-amber-500/20 transition-all hover:scale-[1.02]"
                        >
                          Connect
                        </button>
                      )}
                      ...
                      <button
                        ...
                        className="p-2 rounded-lg text-slate-400 hover:text-slate-200 hover:bg-[#080b11] transition-colors"
                  ...
                  {isExpanded && (
                    <div className="border-t border-[#232f48] p-5 bg-[#080b11]/50 space-y-4">
                            ...
                            <div key={field.key} className="space-y-1">
                              ...
                              {field.type === 'select' ? (
                                <select
                                  ...
                                  className="w-full px-3 py-2 rounded-lg bg-[#080b11] border border-[#232f48] text-xs text-slate-200 focus:outline-none focus:border-amber-400"
                                >
                      ...
                      <div className="pt-2 border-t border-[#232f48]">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {(connector.tools || []).map((t) => (
                            <button
                              ...
                              className="px-2.5 py-1.5 rounded-lg bg-[#080b11] hover:bg-[#1d273e] text-[11px] font-mono text-amber-300 border border-[#232f48] hover:border-amber-400/40 transition-all flex items-center space-x-1.5"
                            >
                        ...
                        {/* Tool Result Preview */}
                        {toolRes && (
                          <div className="mt-3 p-3 rounded-lg bg-[#080b11] border border-[#232f48] max-h-48 overflow-y-auto">
        ...
        {/* Modal Footer */}
        <div className="p-4 border-t border-[#232f48] bg-[#141b2d] flex items-center justify-between text-xs text-slate-400">
          <div className="flex items-center space-x-2">
          ...
          <button
            onClick={onClose}
            className="px-4 py-2 rounded-lg bg-[#080b11] hover:bg-[#1d273e] text-slate-200 font-bold border border-[#232f48] transition-all"
          >
            Done
          </button>
        </div>
