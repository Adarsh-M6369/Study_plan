      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {packs.map((pack, idx) => (
            <div
              key={pack.id || idx}
              className="p-5 rounded-2xl bg-slate-900/60 border border-slate-800 hover:border-sky-500/40 transition-all flex flex-col justify-between space-y-4"
            >
              ...
              <button
                ...
                className="w-full py-2 px-3 rounded-xl bg-slate-800 hover:bg-sky-500 hover:text-slate-950 text-slate-200 text-xs font-bold transition-all flex items-center justify-center space-x-2"
              >
